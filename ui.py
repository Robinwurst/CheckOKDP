...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        hint = QLabel(
            ...
            "Чтение пробует несколько движков и копию файла (как после «Сохранить как» в Excel); "
            "при ошибке откройте проблемный файл в Excel и сохраните новую книгу .xlsx."
        )
